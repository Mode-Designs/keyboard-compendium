...
![2024 Encore](../../assets/encore-2024.webp)

The Encore was our first board designed with someone outside Mode. Matthew Encina of Mod Musings drew it, we produced it, and the two of us spent about a year on it. The idea was a statement piece built on contrast: walnut, maple, and white-oak accents set against anodized aluminum, with thicker bezels and a cherry-lip chamfer along the front edge. It shared its internals with the SixtyFive but stood on its own. We released it as limited series rather than a standing product, including an Industrial Series in translucent materials and metal, capped at 450 units.

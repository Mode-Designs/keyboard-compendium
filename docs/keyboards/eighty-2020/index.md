...
This was where Mode started. We revealed the Eighty on Geekhack's interest-check forums in September 2020: a TKL (tenkeyless) cut from anodized aluminum, with the top and bottom case halves joined into one clean side profile. It introduced our stack-mount, where the PCB, plate, and foam compressed into a single quiet stack for a muted, lower pitched sound. This was offered as a 50-piece Founder's Edition with rose-gold bottoms, a 450-piece First Edition, then a larger standard run. It was what gave Mode the initial momentum to grow into what it is today.

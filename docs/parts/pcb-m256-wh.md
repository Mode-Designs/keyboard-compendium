---
title: 65% PCB / Hotswap / M256-WH
---

`2021 SixtyFive` `2024 SixtyFive` `Envoy` `2024 Encore`

![65% PCB / Hotswap / M256-WH](../assets/pcb-m256-wh.webp)
...
**Firmware:** [mode_m256wh_via.bin :octicons-link-external-16:](https://raw.githubusercontent.com/the-via/firmware/master/mode_m256wh_via.bin){ download target="_blank" rel="noopener" }. Flash it with QMK Toolbox, then remap your keys in [VIA](https://usevia.app){ target="_blank" rel="noopener" }.

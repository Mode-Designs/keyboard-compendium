---
title: Tempo PCB / Hotswap
---

`Tempo`

![Tempo PCB / Hotswap](../assets/pcb-tempo-hs.webp)
...
**Firmware:** [mode_m60h_f_via.bin :octicons-link-external-16:](https://raw.githubusercontent.com/the-via/firmware/master/mode_m60h_f_via.bin){ download target="_blank" rel="noopener" }. Flash it with QMK Toolbox, then remap your keys in [VIA](https://usevia.app){ target="_blank" rel="noopener" }.
